...
class CalorieProvider extends ChangeNotifier {
  ...
  List<double> get last7DaysData {
    // Giả lập dữ liệu 7 ngày (bạn có thể lấy từ Firestore)
    return [1200, 1500, 1800, 1400, 1600, 1700, 1300];
  }

  Future<List<double>> fetchLast7DaysCalories() async {
    if (_userId == null || _userId.isEmpty) return List.filled(7, 0.0);
