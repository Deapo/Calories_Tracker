...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      String? error = await authProvider.signUp(email, password, context);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Thêm thuộc tính backgroundColor vào Scaffold để đặt màu nền
      backgroundColor: Colors.grey[200], // Bạn có thể thay đổi màu này
